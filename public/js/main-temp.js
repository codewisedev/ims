...
!(function (e, t) {
	...
	var i,
		...
		oe =
			...
			(i.fn[t] = u._jQueryInterface),
			(i.fn[t].Constructor = u),
		...
		re =
				...
				return (
					(n.prototype.fixLayoutHeight = function () {
						var e = {
							...
							t = this._max(e);
						d(m).css('min-height', t - e.header),
							d(g).css('min-height', t - e.header);
					}),
					(n.prototype._init = function () {
						var e = this;
						d('body').removeClass(C),
			...
			(d.fn[h] = D._jQueryInterface),
			(d.fn[h].Constructor = D),
		...
		ae =
			...
			(w = '.' + (O = 'lte.pushmenu')),
			(b = E.fn[A]),
			(L = { COLLAPSED: 'collapsed' + w, SHOWN: 'shown' + w }),
			(S = { screenCollapseSize: 768 }),
			(j = {
			...
			(Q = (function () {
				function n(e, t) {
					ie(this, n),
						(this._element = e),
						(this._options = E.extend({}, S, t)),
						E(j.OVERLAY).length || this._addOverlay();
				}
				return (
					(n.prototype.show = function () {
					...
					(n.prototype.toggle = function () {
						(
							E(window).width() >= this._options.screenCollapseSize
								? !E(j.BODY).hasClass(T)
								: E(j.BODY).hasClass(I)
						)
							? this.collapse()
			...
			E(document).on('click', j.TOGGLE_BUTTON, function (e) {
				...
				'pushmenu' !== E(t).data('widget') &&
					(t = E(t).closest(j.TOGGLE_BUTTON)),
					Q._jQueryInterface.call(E(t), 'toggle');
			}),
		...
		se =
				...
				return (
					...
					(i._jQueryInterface = function (n) {
						return this.each(function () {
							...
							e || ((e = new i(R(this), t)), R(this).data(x, e)),
								'init' === n && e[n]();
						});
					}),
					i
			...
			(R.fn[P] = W._jQueryInterface),
			(R.fn[P].Constructor = W),
			(R.fn[P].noConflict = function () {
		...
		ce =
			...
			(te = (function () {
				function n(e, t) {
					ie(this, n),
						(this._element = e),
						(this._parent = e.parents(Z.CARD).first()),
						(this._settings = X.extend({}, ee, t));
				}
				return (
					(n.prototype.collapse = function () {
						var e = this;
						this._parent
							.children(Z.CARD_BODY + ', ' + Z.CARD_FOOTER)
					...
					(n._jQueryInterface = function (t) {
						return this.each(function () {
							...
							e ||
								((e = new n(X(this), e)),
								X(this).data(F, 'string' == typeof t ? e : t)),
								'string' == typeof t && t.match(/remove|toggle/)
									? e[t]()
									: 'object' ===
											('undefined' == typeof t ? 'undefined' : ne(t)) &&
									  e._init(X(this));
						});
					}),
					n
			...
			(X.fn[z] = te._jQueryInterface),
			(X.fn[z].Constructor = te),
